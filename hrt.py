...
def main():
    ...
    if args.u.find(r"http://radio.hrt.hr/arhiva/a{}"):
    ...
    response_hrt = response_hrt[response_hrt.find("col-md-8") + 8 : response_hrt.find("col-sm-4")]
...
def grab_file(link, dl_dir):
    ...
    # find track title
    regexcheck = re.compile(r"track-title\">([\w\s]+)")
